...
def keywords(request):
	...
	if platf == 'Flipkart':
		...
		keyword = [{'keyword_name': 'bevzilla', 'keyword_bid': 31.22, 'keyword_status': 'enabled', 'ad_group_id': '296158477781581', 'ad_group_name': '50 grams x 4 jars sp mt', 'keyword_type': 'EXACT', 'match_type': 'EXACT', 'impressions': 3830.0, 'clicks': 20.0, 'spends': 335.36, 'sales': 599.16, 'campaign_id': '511142057663048', 'campaign_name': '50 grams x 4 jars & Coffee kit sp mt', 'orders': 3.0, 'campaign_type': 'SP', 'roas': 1.79, 'ctr': 0.01}]
