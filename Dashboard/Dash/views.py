...
def keywords(request):
	...
	if platf == 'Flipkart':
		...
		if request.POST:
			a = request.POST.get('para2', None)
			b = request.POST.get('para3', None)
			c = request.POST.get('para4', None)
			print( a, b, c )
		#   Test Input ::--  Product Page 2.5 OWL1UYKSNRYR
			a = a.upper().replace(" ", "_")
			os.system(f"kw_update.py --p1 {a} --p2 {b} --p3 {c} ")
