...
# print(f" Updated_name={args.para1.replace('-', ' ')} , Campagin_id={args.para2}")

def master_command(cook={}, uname=args.para1.replace('-', ' '), cid=args.para2,  bud=args.para3):
    print(uname, cid, bud)
    cookies = {
    ...
    print(f"Updated_name={uname}, budget={bud}")
    json_data = {
