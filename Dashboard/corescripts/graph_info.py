...
def payload(cookie_dict={}):
    cookies_x = {
        ...
        'CURRENT_TENANT': 'BSS',
        '_csrf': '52Oi6EPbB0XqdrNXUGrGgFm1',
        'TENANT': 'BSS',
        ...
        's_sq': 'flipkartsellerprod%3D%2526c.%2526a.%2526activitymap.%2526page%253Dseller%25253A%252520home%252520page%2526link%253DBella%252520vita%252520organic%252520White%252520Oud%252520Eau%252520De%252520Parfum%25252CLong%252520Lasting%25252CUnisex%252520Eau%252520de%252520Parfum%252520-%252520100%252520ml%252520%252528For%252520Men%252520%252526%252520Women%252529%252520SKU%252520ID%25253A%2525203870003433771%252520%2525E2%252582%2525B9%252520%2526region%253Dearn-more-product-details-table%2526pageIDType%253D1%2526.activitymap%2526.a%2526.c%2526pid%253Dseller%25253A%252520home%252520page%2526pidt%253D1%2526oid%253DfunctionBr%252528%252529%25257B%25257D%2526oidt%253D2%2526ot%253DTR',
        's_ppv': 'seller%253A%2520home%2520page%2C100%2C100%2C730%2C923%2C730%2C1536%2C864%2C1.25%2CP',
        ...
        'BSS_SID': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjA1MGRjYzRjLTE0MGYtNDNkYy1iYTUzLTM2NTY3MTQ3MWVlZSJ9..IoZaqL6jVykkW601n6i-AKD2P-gY5hBfRKsS0hjKtBk',
        '_ga': 'GA1.1.1819741834.1700633034',
        'BSS_UDT': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..vRJMpSF_A68LH25e3NWdM6XSVww-m8IFwTk7NB41AH8',
        '_ga_ZPGRNTNNRT': 'GS1.1.1708671272.60.1.1708672470.0.0.0',
        'nonce': 'ss-3385059953',
    }
    ...
    headers = {
        ...
        'x-csrf-token': '5S98JLx5-miW-r8eqnJGvY5pxYe9nhVVgpQM',
        'x-sourceurl': 'https://advertising.flipkart.com/ad-account/?baccount=PHO4MLL4X6QR&aaccount=IIZEQUC5TFAH',
        'x-tenant': 'BSS',
    }

    json_data = {
        'operationName': 'GET_AD_ACCOUNT_HOME_PAGE_DATA',
        'variables': {},
        'query': 'query GET_AD_ACCOUNT_HOME_PAGE_DATA {\n  getAdAccountHomePageData {\n    wallet {\n      amount\n      consumptionGraphData {\n        x\n        y\n        __typename\n      }\n      newWallet\n      __typename\n    }\n    uccWallet {\n      balance\n      __typename\n    }\n    __typename\n  }\n  getWalletCompartment {\n    compartments\n    __typename\n  }\n}\n',
    }
