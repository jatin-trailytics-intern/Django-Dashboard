...
def pauseplay_campagins(cookie_dict={}, acttion=args['para1'], adproduct=args['para2'], entity=args['para3'], cid=args['para4']):
    cookies_x = {
        ...
        'BSS_SID': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImQxZWI3YWU1LTllNmUtNGMxNi04ZjM1LTVlYWJhOGNiYzMyZCJ9..CDfCd5X8VNX2-nP566v1QEJ7Elal6SzVIL5FczviiT8',
        'BSS_UDT': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..0Sr3cimaIXVZFqjROWiysIwcpGg3XD7__uBIojdDqW8',
        '_ga_ZPGRNTNNRT': 'GS1.1.1710334623.117.1.1710335177.0.0.0',
        'nonce': 'ss-1799647045',
    }
    ...
    headers = {
        ...
        'x-baccount': 'N5J3WN87DKC',
        'x-csrf-token': 'tckpp7u4-5pOkM2yLyMMCw2wNKI3BzT12J1A',
        'x-sourceurl': 'https://advertising.flipkart.com/ad-account/campaigns?baccount=N5J3WN87DKC&aaccount=IZJL4R3KCMHR',
        'x-tenant': 'BSS',
    }
