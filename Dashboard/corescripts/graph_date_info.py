...
def dateload(cookie_dict={}):
    cookies_x = {
        ...
        '_csrf': 'Q4fOrDqikQcNnnBF_H00l0w-',
        'TENANT': 'BSS',
        'BSS_SID': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImQxZWI3YWU1LTllNmUtNGMxNi04ZjM1LTVlYWJhOGNiYzMyZCJ9..Ed1iB_CSksS2FgkzhI8Fqk_oroW4AkbV5p9rFpC2cCA',
        'BSS_UDT': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..L30SfYc04eT5OiluRldDPESc2DZQ7A47ErEvCJrWyyY',
        '_ga_ZPGRNTNNRT': 'GS1.1.1708677264.61.1.1708677406.0.0.0',
        'nonce': 'ss-3319722990',
    }
    ...
    headers = {
        ...
        'x-csrf-token': 'Qf6KbqEc-DievA7ieQM28ybNc7t9PhZbsXjg',
        'x-sourceurl': 'https://advertising.flipkart.com/ad-account/?baccount=PHO4MLL4X6QR&aaccount=IIZEQUC5TFAH',
        'x-tenant': 'BSS',
    }

    json_data = {
        'operationName': 'GET_WALLET_CONSUMPTION_GRAPH_DATA',
        'variables': {
            'endDate': '2024-02-08T08:37:09.573Z',
            'startDate': '2024-02-08T08:37:09.573Z',
            'granularity': 'DAY',
        },
        'query': 'query GET_WALLET_CONSUMPTION_GRAPH_DATA($startDate: String!, $endDate: String!, $granularity: String!) {\n  getWalletConsumptionGraphData(startDate: $startDate, endDate: $endDate, granularity: $granularity) {\n    x\n    y\n    __typename\n  }\n}\n',
    }

    # response = requests.post('https://advertising.flipkart.com/api', cookies=cookies_x, headers=headers, json=json_data)

    data = '{"operationName":"GET_WALLET_CONSUMPTION_GRAPH_DATA","variables":{"endDate":"2024-02-23T08:37:09.573Z","startDate":"2024-02-08T08:37:09.573Z","granularity":"DAY"},"query":"query GET_WALLET_CONSUMPTION_GRAPH_DATA($startDate: String!, $endDate: String!, $granularity: String!) {\\n  getWalletConsumptionGraphData(startDate: $startDate, endDate: $endDate, granularity: $granularity) {\\n    x\\n    y\\n    __typename\\n  }\\n}\\n"}'
    response = requests.post('https://advertising.flipkart.com/api', cookies=cookies_x, headers=headers, data=data)
