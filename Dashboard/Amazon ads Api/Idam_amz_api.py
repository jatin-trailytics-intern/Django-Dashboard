...
def convert_to_csv(report_data):
    if report_data:
        with open('report_data.csv', 'w', newline='') as csvfile:
            fieldnames = ['date', 'portfolioName', 'currency', 'campaignName', 'adGroupName',
                          'advertisedASIN', 'impressions', 'clicks', 'ctr', 'cpc', 'spend',
                          '14dTotalSales', 'acos', 'roas', '14dTotalOrders', '14dTotalUnits',
                          '14dConversionRate']
